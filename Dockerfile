...
RUN wget https://files.pythonhosted.org/packages/5d/d4/e81be10be160a6323cf5f29f1eabc9693080cb16780a2e19c96091ee37ee/lxml-4.3.0-cp36-cp36m-manylinux1_x86_64.whl \
  -O /var/cache/lxml-4.3.0-cp36-cp36m-manylinux1_x86_64.whl
RUN pip install wheel
RUN pip install /var/cache/lxml-4.3.0-cp36-cp36m-manylinux1_x86_64.whl
